...
//                .get();
    ...
    public void groupingByFoodType() {
        ...
        //when
        dishesByType.forEach((foodType, dishes) -> System.out.println("foodType = " + foodType + ", dishes = " + dishes));
    ...
    public void divideCalLevelByRange() {
        ...
        //when
        dishesByCalroricLevel.forEach((foodType, dishes) -> System.out.println("foodType = " + foodType + ", dishes = " + dishes));
    ...
    public void find500CalOverDishesWithFilterAndGrouping() {
        ...
        //when
        caloricDishesByType.forEach((foodType, dishes) -> System.out.println("foodType = " + foodType + ", dishes = " + dishes));
    ...
    public void transformElementWithMapping() {
        ...
        //when
        dishNamesByType.forEach((foodType, name) -> System.out.println("foodType = " + foodType + ", name = " + name));
    ...
    public void findNumofDishesType() {
        ...
        //when
        typesCount.forEach((foodType, count) -> System.out.println("foodType = " + foodType + ", count=" + count));
    ...
    public void findTotalCalTypeOfDish() {
        ...
        //when
        totalCalTypeDish.forEach((foodType, totalCal) -> System.out.println("foodType = " + foodType + ", totalCal=" + totalCal));
    ...
    public void findHighestCalFoodByDishType() {
        ...
        //when
        highestCalFoodByType.forEach((foodType, dish) -> System.out.println("foodType = " + foodType + ", dish = " + dish.get().getName()));
